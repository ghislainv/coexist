...
To our knowledge, there is no general model able to predict the _stable_ coexistence of a high number of species.

One example: @Hurtt1995:
...
We will implement a theoretical model of community dynamics with a multidimensional niche for the species.
...
![](outputs/cube/environment.png){width="100%"}

![](outputs/cube/hab_freq.png){width="50%"}
...
![](outputs/cube/species_niche.png){width="50%"}
...
![](outputs/cube/species_habitat_freq.png){width="50%"}
...
![](outputs/cube/community_start.png){width="50%"}
...
![](outputs/cube/hist_mortality.png){width="45%"}
![](outputs/cube/mortality_events.png){width="45%"}
...
![](outputs/cube/species_richness_with_time.png){width="100%"}
...
![](outputs/cube/mean_rank-habitat_freq.png){width="50%"}
...
![](outputs/cube/spatial_comp_env_sp.png){width="100%"}

![](outputs/cube/sp_autocorrelation.png){width="100%"}
...
![](outputs/cube/mortality_rate_community.png){width="100%"}
...
![](outputs/cube/infering_species_niche.png){width="100%"}
...
![](outputs/cube/intraspecific_variance.png){width="100%"}
